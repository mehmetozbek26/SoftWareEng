...
public class ObjectFactory {
    ...
    private final static QName _ProgramDersDBHata_QNAME = new QName("http://schemas.datacontract.org/2004/07/Software", "Hata");
    ...
    public JAXBElement<String> createProgramDersDBHata(String value) {
        return new JAXBElement<String>(_ProgramDersDBHata_QNAME, String.class, ProgramDersDB.class, value);
    }
    ...
    public JAXBElement<String> createKisiBilgileriDBHata(String value) {
        return new JAXBElement<String>(_ProgramDersDBHata_QNAME, String.class, KisiBilgileriDB.class, value);
    }
